...
const placeholderStyles = "text-base text-slate-400/90"
const indicatorContainerStyles = "ml-3.5"
const menuStyles =
  "my-2 border-[0.5px] border-solid shadow-sm border-slate-300/60 rounded-md overflow-hidden text-sm bg-white"
const optionStyles = {
...
const multiOptionStyles = {
  ...
  focused: "bg-primary/10",
  selected: "before:text-primary before:content-[url('@assets/icons/select/select-check.svg')]",
}
const noOptionsMessageStyles = "text-t-gray p-2.5 rounded-md"
